static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_STARTERTOWN - 1] = {MAP_GROUP(STARTERTOWN), MAP_NUM(STARTERTOWN), 9, 9},
    [HEAL_LOCATION_JUNAPUSFOREST - 1] = {MAP_GROUP(JUNAPUSFOREST), MAP_NUM(JUNAPUSFOREST), 14, 18},
    [HEAL_LOCATION_DITTOVILLAGE - 1] = {MAP_GROUP(DITTOVILLAGE), MAP_NUM(DITTOVILLAGE), 10, 10},
};
